...
struct AchievementCardView: View {
    ...
    var body: some View {
        HStack{
            ZStack{
                isCompleted == true ? Image("trophyUnlocked") : Image("trophyLocked")
            }
            ...
            VStack(spacing: 0){
                ...
                if isProgressive == true && !isCompleted {
        ...
        .background{
            RoundedRectangle(cornerRadius: cornerRadius)
                ...
                .foregroundColor(isCompleted == true ? Color("trophyUnlocked") : Color("trophyLocked"))
        }
    }
}
